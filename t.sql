...
CREATE TABLE criterion (inv bool,conj bool,qkey int,key integer primary key asc,isnil bool,aval int,lval bool,qtype int,bval int,regex string,dec bool,exc bool,pos bool,apresent boo, bpresent bool, dec bool);
INSERT INTO criterion VALUES(0,0,0,1,0,0,0,NULL,0,'male|female|other',0,0,0,0,0,0);
INSERT INTO criterion VALUES(0,1,5,2,0,0,0,NULL,26124,'',0,0,0,0,0,0);
INSERT INTO criterion VALUES(1,1,8,3,0,0,0,NULL,1,'',0,0,0,0,0,0);
INSERT INTO criterion VALUES(0,1,20,4,0,0,1,NULL,0,'',0,0,0,0,0,0);
INSERT INTO criterion VALUES(0,0,0,5,0,0,0,NULL,0,'freshmen|sophomore|junior|senior',0,0,0,0,0,0);
INSERT INTO criterion VALUES(0,0,0,6,0,1,0,NULL,5,'',0,0,0,0,0,0);
INSERT INTO criterion VALUES(0,0,0,7,0,1,0,NULL,5,'',0,1,0,0,0,0);
INSERT INTO criterion VALUES(1,0,0,8,0,1,0,NULL,5,'',0,0,0,0,0,0);
