...
CREATE TABLE operator (admin bool,key integer primary key asc,uname string,pwhash string,cursessionid int,cresp int,cser int);
INSERT INTO operator VALUES(1,1,'swiley','e99a18c428cb38d5f260853678922e03',3072778247868547117,4,4);
INSERT INTO operator VALUES(0,2,'cypher','27a77ee1a3120aaea0af2c742fe953e0',3179310945055686338,0,0);
CREATE TABLE criterion (inv bool,conj bool,qkey int,key integer primary key asc,isnil bool,aval int,lval bool,qtype int,bval int,regex string,dec bool,exc bool,pos bool);
INSERT INTO criterion VALUES(0,0,0,1,0,0,0,NULL,0,'male|female|other',0,0,0);
INSERT INTO criterion VALUES(0,1,5,2,0,0,0,NULL,26124,'',0,0,0);
INSERT INTO criterion VALUES(1,1,8,3,0,0,0,NULL,1,'',0,0,0);
INSERT INTO criterion VALUES(0,1,20,4,0,0,1,NULL,0,'',0,0,0);
INSERT INTO criterion VALUES(0,0,0,5,0,0,0,NULL,0,'freshmen|sophomore|junior|senior',0,0,0);
INSERT INTO criterion VALUES(0,0,0,6,0,1,0,NULL,5,'',0,0,0);
INSERT INTO criterion VALUES(0,0,0,7,0,1,0,NULL,5,'',0,1,0);
INSERT INTO criterion VALUES(1,0,0,8,0,1,0,NULL,5,'',0,0,0);
...
INSERT INTO question VALUES(4,'What is your median income? (Please round to an interger dollar value)',1);
...
INSERT INTO question VALUES(18,'How expensive is the home?',1);
...
INSERT INTO question VALUES(22,'',0);
INSERT INTO question VALUES(23,'',0);
INSERT INTO question VALUES(24,'',0);
